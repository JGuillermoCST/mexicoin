...
@php
    ...
    $benefits = [
        ['icon' => '🗂️', 'title' => 'Envío gratis a todo México',        'desc' => ''],
        ['icon' => '📊', 'title' => 'Acceso a todas las funciones básicas',        'desc' => ''],
        ['icon' => '🛡️', 'title' => 'Soporte por Whatsapp',         'desc' => ''],
        ['icon' => '💾', 'title' => 'Promociones especiales',      'desc' => ''],
        ['icon' => '🔄', 'title' => 'Generas puntos por tus compras', 'desc' => ''],
        ['icon' => '🔑', 'title' => 'Desbloqueas un producto exclusivo',           'desc' => ''],
    ];
...
<div class="min-h-screen bg-slate-950 text-slate-100" style="font-family:'DM Sans',sans-serif;">
    ...
    <main class="max-w-5xl mx-auto px-4 sm:px-6 py-10 space-y-6">
        ...
        {{-- ── HERO ── --}}
        <div class="relative rounded-3xl overflow-hidden border border-emerald-900/40 bg-linear-to-br from-emerald-950 via-slate-900 to-slate-950 p-8 sm:p-10">
            ...
            <div class="relative mb-10">
                <div class="h-2.5 bg-slate-800 rounded-full overflow-hidden">
                    <div class="pf-bar h-full rounded-full {{ $rewardUnlocked
                        ? 'bg-linear-to-r from-emerald-500 to-teal-300'
                        : 'bg-linear-to-r from-emerald-800 to-emerald-500' }}"
                        style="width:0%;">
                    </div>
                </div>
        ...
        {{-- ── RECOMPENSA ── --}}
        @if($rewardUnlocked)
            <div class="reward-glow relative rounded-3xl overflow-hidden border border-emerald-400/40 bg-linear-to-br from-emerald-950/60 via-slate-900 to-slate-950 p-8">
                ...
                <div class="relative flex flex-col sm:flex-row items-start sm:items-center gap-6">
                    ...
                    <button class="shrink-0 inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-500 active:scale-95 text-white font-bold text-sm px-6 py-3 rounded-xl transition-all hover:shadow-lg hover:shadow-emerald-600/30">
                        Reclamar recompensa
            ...
            <div class="relative rounded-3xl overflow-hidden border border-white/5 bg-slate-900">
                ...
                <div class="opacity-25 pointer-events-none p-8 flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-400">Insignia de fundador + Libro numismática anual</p>
                    </div>
                </div>
            </div>
        @endif
        ...
        {{-- ── UPGRADE BANNER ── --}}
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-linear-to-r from-blue-950/60 to-slate-900 border border-blue-800/30 rounded-2xl px-6 py-5">
            <div class="flex items-center gap-4">
                <div class="w-10 h-10 rounded-xl bg-blue-600/20 border border-blue-500/30 flex items-center justify-center text-lg shrink-0">🚀</div>
                <div>
                    <p class="text-sm font-semibold text-slate-100">¿Listo para más?</p>
                    <p class="text-xs text-slate-500 mt-0.5">El plan Pro empaqueta las mejores características.</p>
                </div>
            </div>
            <a href="{{ route('subs') }}"
               class="shrink-0 inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition-all hover:shadow-lg hover:shadow-blue-600/30">
                Ver Plan Pro
