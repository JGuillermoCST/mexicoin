    ...
    <div id="animation-carousel" class="relative w-full lg:w-10/12 xl:w-9/12 mx-auto" data-carousel="static">
        ...
        <div class="relative overflow-hidden rounded-base h-[710px] md:h-[670px]">
            ...
            <div class="hidden duration-200 ease-linear" data-carousel-item>
                ...
                <div id="plata" class="flex-col w-full max-w-6xl mx-auto mt-12 absolute block -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                    <div class="text-center mb-12">
                        ...
                        <div class="mt-3 h-1 w-24 bg-linear-to-r from-gray-300 to-gray-500 mx-auto rounded-full shadow-lg"></div>
                    </div>
                        ...
                        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            <div class="shadow-lg overflow-hidden border border-gray-200 sm:rounded-2xl">
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-linear-to-r from-gray-100 to-gray-200">
                                        <tr>
            ...
            <div class="hidden duration-200 ease-linear" data-carousel-item>
                ...
                <div id="plata" class="flex-col w-full max-w-6xl mx-auto mt-12 absolute block -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                    <div class="text-center mb-12">
                        <h2 class="text-2xl md:text-3xl lg:text-4xl font-extrabold text-indio-oscuro tracking-tight">
        ...
        <!-- Slider controls -->
        <button type="button" class="absolute top-0 inset-s-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
