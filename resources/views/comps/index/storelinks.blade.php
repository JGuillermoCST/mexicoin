...
<section class="py-16 bg-white">
  <div class="max-w-6xl mx-auto px-4">
    ...
    <div class="mt-2 h-1 w-24 bg-linear-to-r from-sky-400 to-blue-500 mx-auto rounded-full"></div>
            ...
            <div class="grid gap-6 grid-cols-2 md:grid-cols-4">
                @foreach ([
                    ...
                    ['nombre' => 'Numismática', 'imagen' => 'https://www.banxico.org.mx/multimedia/rev_1kg_oro.png', 'filtro' => 'especiales', 'link' => route('collections-numis')],
