<div class="block md:hidden relative mx-auto w-11/12" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative h-128 overflow-hidden rounded-lg md:h-96">
                ...
                <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm ">
                    ...
                    <div class="w-11/12 mx-auto max-w-sm bg-white rounded-lg shadow-sm">
                        <a href="{{ route('product.detail', ['id' => $producto['id']]) }}">
                            <img src="{{ asset('assets/products/mains/'. $producto['image']) }}" alt="{{ asset('assets/products/mains/'. $producto['image']) }}" class="p-8 w-full h-80 object-cover rounded-xl"  />
                        </a>
    ...
    <!-- Slider controls -->
    <button type="button" class="absolute top-0 inset-s-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none animate-none" data-carousel-prev style="animation: none">
    ...
    <button type="button" class="absolute top-0 inset-e-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-next style="animation: none">
        <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-black/30 group-hover:bg-white/50 group-focus:ring-4 group-focus:ring-white group-focus:outline-none">
            <svg class="w-4 h-4 text-white rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
...
<div class="hidden md:block lg:hidden relative mx-auto w-11/12" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative h-104 overflow-hidden rounded-lg">
            ...
            @foreach ($featured as $producto)
                ...
                @if ($loop->iteration <= 3)
                    ...
                    <div class="w-11/12 mx-auto max-w-sm bg-white rounded-lg shadow-sm border border-gray-200">
                        <img class="w-full p-2 h-52 object-cover rounded-xl" src="{{ asset('assets/products/mains/'. $producto['image']) }}" alt="{{ asset('assets/products/mains/'. $producto['image']) }}" />
                        <div class="px-5 pb-5">
                            <a href="#">
...
<div class="hidden lg:block relative mx-auto w-10/12 xl:w-8/12" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative h-112 xl:h-128 overflow-hidden rounded-lg">
        ...
        <div class="duration-700 ease-in-out flex flex-row" data-carousel-item>
            ...
            @foreach ($featured as $producto)
                ...
                @if ($loop->iteration <= 3)
                    ...
                    <div class="w-11/12 mx-auto max-w-sm bg-white rounded-lg shadow-sm border border-gray-200">
                        <img class="w-full p-2 h-60 xl:h-76 object-cover rounded-xl" src="{{ asset('assets/products/mains/'. $producto['image']) }}" alt="{{ asset('assets/products/mains/'. $producto['image']) }}" />
                        <div class="px-5 pb-5">
                            <a href="#">
